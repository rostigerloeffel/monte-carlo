const en = {
  ...
  'chart.monte-carlo.iterations.tooltip': 'Set the number of Monte Carlo simulations. More iterations lead to more precise results but require more computation time.',
