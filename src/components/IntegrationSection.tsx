  ...
  return (
    <div style={{ width: '100%', maxWidth: 900, marginTop: 24 }}>
      ...
      <div style={{ display: 'flex', gap: 20, alignItems: 'center', flexWrap: 'wrap' }}>
        ...
        >
          <svg width="22" height="22" viewBox="0 0 25 25" fill="currentColor" style={{ flexShrink: 0, marginTop: '-1px' }}>
        ...
        >
          <svg width="22" height="22" viewBox="0 0 100 100" fill="currentColor" style={{ flexShrink: 0, marginTop: '-1px' }}>
