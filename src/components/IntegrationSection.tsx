  ...
  return (
    <div style={{ width: '100%', maxWidth: 900, marginTop: 24 }}>
      ...
      <div style={{ display: 'flex', gap: 20, alignItems: 'center', flexWrap: 'wrap' }}>
        ...
        >
          <svg width="22" height="22" viewBox="0 0 21 21" fill="currentColor" style={{ flexShrink: 0 }}>
        ...
        >
          <svg width="22" height="22" viewBox="0 0 63 63" fill="currentColor" style={{ flexShrink: 0 }}>
